let produtos = [
  ...
  {
    id: 59,
    nome: "Hastes Flexíveis (Cotonete)",
    preco_venda: 4.0,
    preco_compra: 2.1,
    estoque: 90,
    rotatividade: "media",
...
// let litas_frutas = ["maca", "pera", "banana"];
// let litas_frutas2 = [{ fruta: "maca" }, { fruta: "pera" }, { fruta: "banana" }];
// console.log(litas_frutas[0]);
// console.log(litas_frutas2[2]);
...
// let nomes = produtos.map((joaozinho) => joaozinho.nome);
// console.log(nomes);

// let comDesconto = produtos.map((produto) => ({
//   ...produto,
//   preco_com_desconto: produto.preco_venda * 0.9,
// }));
// console.table(comDesconto);

// let estoquea = produtos.filter(
//   (x) => x.estoque < 51 && x.rotatividade === "alta" && x.curva_abc === "A",
// );
// console.table(estoquea);
